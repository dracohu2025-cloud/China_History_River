        ...
        >
                            ...
                            >
                                ...
                                <g pointerEvents="none">
                                    {series.map(layer => {
                                        ...
                                        // Calculate estimated text width and hide if it would overflow significantly
                                        const estimatedTextWidth = name.length * fontSize * 0.6; // Approximate char width
                                        if (estimatedTextWidth > widthPx * 1.5) return null; // Only hide if text is much wider than available space
            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column-reverse' }}>
                    <button
                        onClick={() => setShowBookCollectionModal(!showBookCollectionModal)}
                        style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: 6,
                            ...
                            color: 'white',
                            border: 'none',
                            borderRadius: showBookCollectionModal ? '0 0 8px 8px' : 8,
                            cursor: 'pointer',
                            fontSize: 13,
                            fontWeight: 600,
                    ...
                    >
                        ...
                        {showBookCollectionModal ? (
                            ...
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" style={{ transform: 'rotate(180deg)' }}>
                    ...
                    {showBookCollectionModal && (
                        <div style={{
                            ...
                            />
                            <p style={{ fontSize: 12, color: '#6b7280', textAlign: 'center', marginTop: 8, marginBottom: 0 }}>
                                扫码推荐好书
                            </p>
                        </div>
                    )}
                ...
                <div style={{ display: 'flex', flexDirection: 'column-reverse' }}>
                    <button
                        ...
                        style={{
                            ...
                            color: 'white',
                            border: 'none',
                            borderRadius: showTipModal ? '0 0 8px 8px' : 8,
                            cursor: 'pointer',
                            fontSize: 13,
                            fontWeight: 600,
                            boxShadow: '0 2px 8px rgba(0,0,0,0.2)',
